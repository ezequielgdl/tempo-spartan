  ...
  template: `
    <section hlmCard id="login-card">
      <div hlmCardHeader>
        ...
        <p hlmCardDescription id="login-description">
      ...
      <form [formGroup]="loginForm" (ngSubmit)="onSubmit()" id="login-form">
        <p hlmCardContent>
          <hlm-form-field>
            ...
            <hlm-error id="email-invalid-error"
              >Your email is not valid</hlm-error
            >
            } @if (loginForm.get('email')?.errors?.['required']) {
            <hlm-error id="email-required-error"
              >Your email is required</hlm-error
            >
            }
          </hlm-form-field>
          <hlm-form-field>
            ...
            <hlm-error id="password-required-error"
              >Your password is required</hlm-error
            >
            }
          </hlm-form-field>
          @if (errorMessage) {
